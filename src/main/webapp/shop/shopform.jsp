...
<h2>홈쇼핑 회원 등록</h2>
<br>
<form name="f1" onSubmit="return formCh()" action="${path}/insertshop.do">
<table border=1>
<tr>
<td>회원번호</td><td><input type=number id="custno" name=custno value="${m.custno}"></td>
</tr>
<tr>
<td>회원성명</td><td><input type=text id="custname" name=custname></td>
</tr>
<tr>
<td>아이디</td><td><input type=text name=id id="id" required><input type=button value="아이디체크" id="ckBtn"></td>
</tr>
<tr>
...
<td>
<div align=left>
    <input type="text" name="addresscode" id="sample4_postcode" placeholder="우편번호" >
...
<tr>
<td>도시코드</td><td><input type=text name=city id="city"></td>
</tr>
<tr>
<td colspan=2 align=center><input type=submit value="등 록" >&emsp;<input type=button value="조 회"></td>
</tr>
