...
<div align=center>
<h2>쇼핑몰 상품등록 하기</h2>
<form name=f1 action="${path}/productform.do" method="post" enctype="multipart/form-data" >
...
<tr><td align="center">상품설명</td>  
   <td><textarea cols=60  rows=9 name=pdesc > </textarea> </td></tr>
<tr><td align="center">사진첨부</td>  
   <td><input type=file name=pimg  /> </td></tr>
